...
* __Aplicação Cliente__: Esta aplicação utilizou em seu fron-end a versão 6 do framework javascript[Angular][9], pela quantidade de documentação existente, suporte ao desenvolvedores e difusão de utilização alcançada.
